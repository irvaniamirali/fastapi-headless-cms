...
@pytest.mark.asyncio
async def test_create_reply_to_different_post(http_client, registered_user, create_comment_fixture, create_post_fixture):
    ...
    assert response.json()["error"]["message"] == "Parent comment belongs to a different post"
